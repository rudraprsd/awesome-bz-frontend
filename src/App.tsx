    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans">
      ...
      <main className="max-w-[1800px] mx-auto p-4 sm:p-6 lg:p-8">
        <BZForm 
          ...
          error={error}
          visualizer={
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden min-h-[700px] flex flex-col relative group h-full">
              ...
              <div className="flex-1 relative w-full h-full min-h-[600px]">
                {!plotData && !isLoading && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-slate-400 p-12 text-center">
                    ...
                    <h3 className="text-lg font-medium text-slate-600 mb-2">No Visualization</h3>
                    <p className="max-w-xs text-sm">Configure structure and settings, then click "Generate".</p>
                  </div>
                )}
                ...
                {isLoading && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/80 backdrop-blur-sm z-10">
                    ...
                    <p className="mt-4 text-indigo-600 font-medium animate-pulse">Calculating...</p>
                  </div>
                )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-slate-600">
                Made with ❤️ by <a href="https://rudraprsd.github.io/" target="_blank" rel="noreferrer" className="font-medium text-indigo-600 hover:underline">Rudra Prasad Sahu</a>
              </p>
